        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppliedFivePercentDiscount = table.Column<bool>(type: "boolean", nullable: false),
                    AppliedTenPercentDiscount = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProcessedOrderId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    OrderId = table.Column<int>(type: "integer", nullable: false),
                    StaffId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessedOrders", x => x.ProcessedOrderId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProcessedOrders_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessedOrders_StaffId",
                table: "ProcessedOrders",
                column: "StaffId");
