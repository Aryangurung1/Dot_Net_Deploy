...
const Orders = () => {
    ...
    if (!loading && orders.length > 0) {
      ...
      Promise.all(
        ...
        results.forEach(result => {
          if (result && result.data) details[result.id] = result.data;
        });
  ...
  if (!loading && orders.length > 0) {
    // Debug: log the first order's items to inspect their structure
                          ...
                          return (
                            <div key={index} className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                <img
                                  src={imageUrl}
                                  alt={bookDetails[item.bookId]?.title || item.title || 'Book'}
                                ...
                                <div>
                                  ...
                                  >
                                    {bookDetails[item.bookId]?.title || item.title}
                                  </Link>
